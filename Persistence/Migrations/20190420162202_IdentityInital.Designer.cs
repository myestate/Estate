...
namespace Persistence.Migrations
{
    ...
    [Migration("20190420162202_IdentityInital")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEstate.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyEstate.Domain.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("MyEstate.Domain.Entities.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MyEstate.Domain.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyEstate.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("MyEstate.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
